...
// Sat Jan  9 10:57:21 2021 by ROOT version 6.22/06
...
// Declaration of leaf types
   ...
   //}
	...
	private:
		...
		TCanvas		*canv2;
		TCanvas		*canv3;
		TString		variables[8] = {"ele_pt", "scl_eta", "ele_hadronicOverEm", "ele_gsfchi2", "ele_fbrem", "ele_ep", "ele_eelepout", "ele_pfChargedHadIso"};
		TLegend		*legend[8];
		TLegend		*legend2;
		TLine		*line1;
		TLine		*line2;
...
#ifdef Analyzer_cxx
Analyzer::Analyzer(TTree *tree) : fChain(0) //konstruktor
{
...
// used to generate this class and read the Tree.
	...
	histo_back[0] = new TH1F("histo_back_1", variables[0], 50, 0, 100);
	histo_sign[0] = new TH1F("histo_sign_1", variables[0], 50, 0, 100);
	histo_back[1] = new TH1F("histo_back_2", variables[1], 50, -3, 3);
	histo_sign[1] = new TH1F("histo_sign_2", variables[1], 50, -3, 3);
	histo_back[2] = new TH1F("histo_back_3", variables[2], 50, 0, 0.025);
	histo_sign[2] = new TH1F("histo_sign_3", variables[2], 50, 0, 0.025);
	histo_back[3] = new TH1F("histo_back_4", variables[3], 50, 0, 8);
	histo_sign[3] = new TH1F("histo_sign_4", variables[3], 50, 0, 8);
	histo_back[4] = new TH1F("histo_back_5", variables[4], 50, -1.5, 1.5);
	histo_sign[4] = new TH1F("histo_sign_5", variables[4], 50, -1.5, 1.5);
	histo_back[5] = new TH1F("histo_back_6", variables[5], 50, 0, 10);
	histo_sign[5] = new TH1F("histo_sign_6", variables[5], 50, 0, 10);
	histo_back[6] = new TH1F("histo_back_7", variables[6], 50, 0, 25);
	histo_sign[6] = new TH1F("histo_sign_7", variables[6], 50, 0, 25);
	histo_back[7] = new TH1F("histo_back_8", variables[7], 50, 0, 1);
	histo_sign[7] = new TH1F("histo_sign_8", variables[7], 50, 0, 1);
}
